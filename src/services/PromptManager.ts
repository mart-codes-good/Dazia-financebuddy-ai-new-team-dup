...
{{/if}}`,
    ...
    this.addTemplate({
      ...
      version: this.defaultVersion,
      template: `Generate the correct answer and {{distractorCount}} plausible distractors for this question:
...
- Create exactly {{distractorCount}} plausible but incorrect distractors
...
{{/each}}
{{/if}}`,
      variables: ['questionText', 'context', 'distractorCount', 'difficulty', 'documents'],
